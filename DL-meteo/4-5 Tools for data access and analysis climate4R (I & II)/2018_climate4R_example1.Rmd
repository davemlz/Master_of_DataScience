...
path = "C:/Users/Dave Mont/Desktop/Master_of_DataScience/DL-meteo/4-5 Tools for data access and analysis climate4R (I & II)/my_dict.dic"
file.create(path)
...
d,offset,scale,deaccum,derived,interface",
             "tasmax,tx,24h,0,24,max,0,1,0,0,"), path)
```
...
dir <- "C:/Users/Dave Mont/Desktop/sim/Simulaciones EC-EARTH-20200331/tasmax_historical/tasmax_historical/tasmax"
dirf <- "C:/Users/Dave Mont/Desktop/sim/Simulaciones EC-EARTH-20200331/tasmax_rcp85/tasmax_rcp85/tasmax"

list.files(dirf, recursive = T)
```
...
dir.ncml = paste0(dir,"/CDX_hist.ncml")
dirf.ncml = paste0(dirf,"/CDX_rcp85.ncml")

makeAggregatedDataset(source.dir = dir, recursive = T, ncml.file = dir.ncml)
makeAggregatedDataset(source.dir = dirf, recursive = T, ncml.file = dirf.ncml)
```
...
dir.dic = paste0(dirf,"/dicCDX.dic")
file.create(dir.dic)
writeLines(c("identifier,short_name,time_step,lower_time_bound,upper_time_bound,cell_metod,offset,scale,deaccum,derived,interface", "tasmax,tasmax,24h,0,24,max,-273.15,1,0,0,"), "dicCDX.dic")
```
...
SUh <- loadGridData(dataset = dir.ncml,
                     var = "tasmax",
                     season = 1:12,
                     lonLim = lon,
                     latLim = lat,
...
SUf <- loadGridData(dataset = dirf.ncml,
                     var = "tasmax",
                     season = 1:12,
                     lonLim = lon,
                     latLim = lat,
