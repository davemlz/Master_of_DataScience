...
Utilizando otras dos variables, el árbol óptimo, con una profundidad de tamaño 2, apenas alcanza una precisión en su proceso de validación cercana al 76%. El árbol óptimo con las variables `odor` y `ring.type` es, en los 3 casos sigue siendo el mejor modelo.
