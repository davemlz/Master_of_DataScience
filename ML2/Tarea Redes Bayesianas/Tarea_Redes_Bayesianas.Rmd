...
Aunque los métodos de aprendizaje automático agregan relaciones que pueden ser adecuadas, existen también relaciones como granizo -> rocio, que aunque indiquen una dependencia, que pueda no ser muy alta, no aportan a una relación causa-efecto significativa. En este caso hace falta un aporte experto para manejar los arcos dirigidos de los grafos.
