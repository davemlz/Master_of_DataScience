...
## Demo Script
##
## Oracle R Enterprise 1.4.1 with Oracle Big Data SQL
## and Oracle R Advanced Analytics for Hadoop 2.5.0
##
...
# of the R table class  : Screenshot_hist_0005.png
plot(act.tab,col="red",main="Activity vs. Recommended")

# Generic statistics on the Data on HIVE, illustrated
# through the transparency of the function hist() : Screenshot_hist_0006.png
hist(mov$ACTIVITY,
     col="red",
...
# Generates a Box-Plot on Gross Earnings by Genre : Screenshot_hist_0008.png
...
# Plots the top 25 rules into a Graph : Screenshot_hist_0009.png
