...
En la gráfica anterior se observa cómo el ajuste de la función exponencial utilizando los parámetros N y lamnda que maximizan el likelihood se ajustan adecuadamente al histograma.